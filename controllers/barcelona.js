...
const getAll = async (req, res, next) => {
  try{
    const result = await mongodb.getDb().db().collection('barcelona').find();
  ...
  const createPlayer = async (req, res) => {
    ...
    const response = await mongodb.getDb().db().collection('barcelona').insertOne(contact);
  ...
  const updatePlayer = async (req, res) => {
    ...
    try{
      ...
      const response = await mongodb.getDb().db().collection('barcelona').replaceOne({ _id: userId }, contact);
  ...
  const deletePlayer = async (req, res) => {
    ...
    try{
      const userId = new ObjectId(req.params.id);
      const response = await mongodb.getDb().db().collection('barcelona').deleteOne({ _id: userId });
      console.log(response)
